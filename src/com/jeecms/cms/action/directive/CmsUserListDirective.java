...
import com.jeecms.cms.action.directive.abs.AbstractCmsUserDirective;
 ...
 * 内容列表标签
 */
public class CmsUserListDirective extends AbstractCmsUserDirective {
	/**
	 * 模板名称
	 */
	public static final String TPL_NAME = "user_list";
	/**
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Integer groupId = DirectiveUtils.getInt(AbstractCmsUserDirective.PARAM_GROUP_ID, params);
		List<CmsUser> list = cmsUserMng.getList(null, null, site.getId(), groupId, null, null, null);
